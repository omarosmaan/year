...
(function ($) {
  ...
  function Rocket(data) {
    ...
    this.vel.y = Math.random() * -2 - 6;
    this.vel.x = Math.random() * 6 - 4;
    this.size = 3;
    this.shrink = 1.008;
    this.gravity = 0.01;
  }
  ...
  Rocket.prototype.explode = function (data) {
    ...
    for (var i = 0; i < count; i++) {
      ...
      var speed = Math.cos((Math.random() * Math.PI) / 4) * 15;
      ...
      particle.shrink = Math.random() * 0.05 + 0.92;
  ...
  Rocket.prototype.render = function (c) {
    ...
    var gradient = c.createRadialGradient(x, y, 0.1, x, y, r);
    gradient.addColorStop(0.1, "rgba(255, 0, 255 ," + this.alpha + ")");
    gradient.addColorStop(0.2, "rgba(255, 100, 0, " + this.alpha + ")");
